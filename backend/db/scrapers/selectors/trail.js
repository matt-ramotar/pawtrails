module.exports = {
  ...
  ELEVATION_GAIN:
    '#trail-stats > div > span.elevation-icon > span.detail-data.xlate-none',
  LOOP: '#trail-stats > div > span.route-icon.loop > span.detail-data',
  OUT_AND_BACK:
    '#trail-stats > div > span.route-icon.out-and-back > span.detail-data',
  POINT_TO_POINT:
    '#trail-stats > div > span.route-icon.point-to-point > span.detail-data',
  TAG_CLOUD:
